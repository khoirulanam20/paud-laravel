<x-app-layout>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" x-data="{ showCreateModal:false, showDeleteModal:false, deleteRoute:'', openDelete(r){this.deleteRoute=r;this.showDeleteModal=true} }">
            ...
            <div class="overflow-x-auto">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="4" class="py-12 text-center" style="color:#9E9790;">Belum ada akun admin sekolah.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>

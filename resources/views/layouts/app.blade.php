@php
    ...
    if ($user && $user->hasRole('Admin Kelas')) {
        $roleNavItems = array_merge($roleNavItems, [
            ...
            ['route' => 'adminkelas.kegiatan.index', 'label' => 'Jurnal Kelas', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'pattern' => 'adminkelas.kegiatan.*'],
    ...
    if ($user && $user->hasRole('Pengajar')) {
        ...
        if (! $user->hasRole('Admin Kelas')) {
            $pengajarNav[] = ['route' => 'pengajar.presensi.index', 'label' => 'Presensi', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'pattern' => 'pengajar.presensi.*'];
        }

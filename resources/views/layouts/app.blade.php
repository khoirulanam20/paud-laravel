        ...
        $roleNavItems = array_merge($roleNavItems, [
            [
                ...
                'items' => [
                    ...
                    ['route' => 'admin.presensi.index', 'label' => 'Presensi Siswa', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'pattern' => 'admin.presensi.*'],
            ...
            [
                ...
                'items' => [
                    ...
                    ['route' => 'admin.skala-pencapaian.index', 'label' => 'Skala Capaian', 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', 'pattern' => 'admin.skala-pencapaian.*'],
            ...
            [
                'group' => 'Akuntansi',
                'items' => [
                    ['route' => 'admin.akun.index', 'label' => 'Akun (COA)', 'icon' => 'M4 6h16M4 10h16M4 14h16M4 18h16', 'pattern' => 'admin.akun.*'],
                    ...
                    ['route' => 'admin.jurnal.index', 'label' => 'Jurnal Umum', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'pattern' => 'admin.jurnal.*'],
            ...
            [
                ...
                'items' => [
                    ['route' => 'admin.biaya-bulanan.index', 'label' => 'Biaya Harian', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402-2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'pattern' => 'admin.biaya-bulanan.*'],
                    ['route' => 'admin.diskon.index', 'label' => 'Diskon', 'icon' => 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', 'pattern' => 'admin.diskon.*'],
                    ['route' => 'admin.pembayaran-bulanan.index', 'label' => 'Rekap Pembayaran', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', 'pattern' => 'admin.pembayaran-bulanan.*'],
                ]
            ],
            [
                'group' => 'Laporan Keuangan',
                'items' => [
                    ['route' => 'admin.laporan.arus-kas', 'label' => 'Arus Kas (PSAK 2)', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'pattern' => 'admin.laporan.arus-kas'],
                    ['route' => 'admin.laporan.neraca', 'label' => 'Neraca', 'icon' => 'M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', 'pattern' => 'admin.laporan.neraca'],
                    ['route' => 'admin.laporan.laba-rugi', 'label' => 'Laba Rugi', 'icon' => 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', 'pattern' => 'admin.laporan.laba-rugi'],
                ]
            ],
            [
                ...
                'items' => [
                    ...
                    ['route' => 'admin.ai-persona.index', 'label' => 'Pengaturan AI', 'icon' => 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z', 'pattern' => 'admin.ai-persona.*'],
                ]
            ],
        ]);
    }

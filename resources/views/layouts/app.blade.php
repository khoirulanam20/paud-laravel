@php
    ...
    if ($user && $user->hasRole('Admin Kelas')) {
        $roleNavItems = array_merge($roleNavItems, [
            ['group' => 'Kelas saya', 'items' => [
                ...
                ['route' => 'adminkelas.matrikulasi.index', 'label' => 'Indikator Matrikulasi', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'pattern' => 'adminkelas.matrikulasi.*'],
            ]],
        ]);
    }
    ...
    if ($user && $user->hasRole('Orang Tua')) {
        $roleNavItems = array_merge($roleNavItems, [
            ...
            ['route' => 'orangtua.kegiatan.index', 'label' => 'Jurnal Kegiatan', 'icon' => 'M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'pattern' => 'orangtua.kegiatan.*'],

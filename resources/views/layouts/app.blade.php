    ...
    if ($user && $user->hasRole('Admin Sekolah')) {
        $roleNavItems = array_merge($roleNavItems, [
            ...
            [
                ...
                'items' => [
                    ['route' => 'admin.biaya-bulanan.index', 'label' => 'Biaya Harian', 'perm' => 'menu.biaya-harian', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402-2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'pattern' => 'admin.biaya-bulanan.*'],
            ...
            [
                ...
                'items' => [
                    ['route' => 'admin.laporan.arus-kas', 'label' => 'Arus Kas (PSAK 2)', 'perm' => 'menu.arus-kas', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'pattern' => 'admin.laporan.arus-kas'],
                    ['route' => 'admin.laporan.neraca', 'label' => 'Neraca', 'perm' => 'menu.neraca', 'icon' => 'M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', 'pattern' => 'admin.laporan.neraca'],
                    ['route' => 'admin.laporan.laba-rugi', 'label' => 'Laba Rugi', 'perm' => 'menu.laba-rugi', 'icon' => 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', 'pattern' => 'admin.laporan.laba-rugi'],
                ]
            ],
            [

    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" data-tour="page-header">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route((auth()->user()->kegiatanRutinRoutePrefix()).'kegiatan-rutin.index') }}" class="btn-secondary py-2 px-4 rounded-xl font-bold shadow-sm inline-flex items-center gap-2 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 transition">
                            ...
                            <tr class="hover:bg-gray-50/30 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route((auth()->user()->kegiatanRutinRoutePrefix()).'master-kegiatan-rutin.destroy', $master) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');" class="inline-block">
                                            @csrf
                                            @method('DELETE')

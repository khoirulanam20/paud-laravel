<x-app-layout>
    ...
    <div class="py-4 md:py-8 px-3 md:px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="card overflow-hidden mb-6">
            <div class="px-6 py-6 border-b" style="background:#FAF6F0; border-color: rgba(0,0,0,0.06);">
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <form data-tour="admin-presensi-filter" method="get" action="{{ route('admin.presensi.index') }}" class="grid grid-cols-2 gap-4 w-full md:w-auto">
                        ...
                        <div class="col-span-2 sm:col-span-1 flex items-end">
                            <x-filter-reset :href="route('admin.presensi.index')" />
                        </div>
                    </form>
        ...
        <div class="card overflow-hidden">
            ...
            @else
                <form data-tour="admin-presensi-checklist" method="post" action="{{ route('admin.presensi.store') }}">
                    @csrf
